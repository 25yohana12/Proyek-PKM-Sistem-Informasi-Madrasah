    ...
    <div class="card-container">
        <div class="card">
            ...
            <div class="card-text">
                ...
                <a href="{{ route('siswa.siswa.ekstrakulikuler') }}" class="button">Lainnya</a>
            </div>
        </div>
        <div class="card">
            ...
            <div class="card-text">
                ...
                <a href="{{ route('siswa.siswa.prestasi') }}" class="button">Lainnya</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="card-container">
        <div class="card">
            ...
            <div class="card-text">
                ...
                <a href="{{ route('siswa.siswa.fasilitas') }}" class="button">Lainnya</a>
            </div>
        </div>
        <div class="card">
            ...
            <div class="card-text">
                ...
                <a href="{{ route('siswa.siswa.siswa') }}" class="button">Lainnya</a>
            </div>
        </div>
    </div>
</section>
