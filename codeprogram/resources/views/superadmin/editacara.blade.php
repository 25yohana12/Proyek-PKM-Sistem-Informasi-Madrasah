    ...
    <div class="page-container">
        ...
        <div class="page-header">
            <div class="header-content">
                <h1 class="page-title">
                    <span class="emoji">✏️</span> Edit Acara
                </h1>
                <p class="page-subtitle">Ubah informasi acara dan perayaan madrasah</p>
            </div>
        </div>
        ...
        <div class="content-card">
            ...
            <div class="card-body">
                <form action="{{ route('superadmin.acara.update', $acara->acara_id) }}" method="POST" enctype="multipart/form-data" class="modern-form">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" 
                               ...
                               value="{{ old('tanggalAcara', $acara->tanggalAcara) }}" 
                               required>
                        @error('tanggalAcara')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <!-- Gambar Existing -->
                    @php
                        $existingImages = json_decode($acara->gambar, true) ?? [];
                    @endphp
                    ...
                    @if(!empty($existingImages))
                        <div class="form-group">
                            ...
                            <div class="existing-images">
                                @foreach($existingImages as $index => $image)
                                    <div class="existing-image-item">
                                        <img src="{{ Storage::url($image) }}" alt="Existing Image" class="existing-image">
                            ...
                            <small class="form-text text-muted">
                                ...
                                Foto yang sudah ada akan tetap tersimpan. Anda bisa menambahkan foto baru di bawah.
                            </small>
                        </div>
                    @endif
...
@section('styles')
    <style>
        /* Menggunakan style yang sama dengan createacara.blade.php */
        .page-container {
            padding: 2rem;
        ...
        .existing-image-item:hover .existing-image {
        ...
        /* File Upload Area - sama dengan create */
        .file-upload-area {
            position: relative;
        ...
        /* Preview styles - sama dengan create */
        .image-preview-area {
            background: #f8fafc;
            border-radius: 12px;
            padding: 1.5rem;
...
@section('scripts')
    <script>
        // Menggunakan script yang sama dengan createacara.blade.php
