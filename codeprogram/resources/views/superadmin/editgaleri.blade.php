    ...
    <div class="page-container">
        ...
        <div class="page-header">
            <div class="header-content">
                <h1 class="page-title">
                    <span class="emoji">✏️</span> Edit Galeri
                </h1>
                <p class="page-subtitle">Ubah dan perbarui informasi galeri madrasah</p>
            </div>
            <div class="breadcrumb">
                ...
                <span class="breadcrumb-current">Edit Galeri</span>
            </div>
        </div>

        <!-- Form Container -->
        <div class="form-container">
            <form action="{{ route('superadmin.galeri.update', $galeri->galeri_id) }}" method="POST" enctype="multipart/form-data" class="modern-form">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <input type="text" 
                           ...
                           required>
                    <div class="form-hint">Berikan judul yang menarik untuk galeri Anda</div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="deskripsi" 
                              ...
                              class="form-control" 
                              rows="4" 
                              placeholder="Deskripsikan galeri ini..."
                              required>{{ old('deskripsi', $galeri->deskripsi) }}</textarea>
                    <div class="form-hint">Jelaskan tentang foto-foto yang akan ditampilkan</div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="current-images">
                        @foreach(json_decode($galeri->gambar) as $index => $image)
                ...
                <div class="form-group">
                    ...
                    <div class="form-hint">Foto baru akan ditambahkan ke galeri yang sudah ada</div>
                </div>
