...
<div class="page-container">
    ...
    <div class="page-header">
        <div class="header-content">
            ...
            <p class="page-subtitle">Lihat detail lengkap kegiatan ekstrakurikuler</p>
        </div>
    </div>
        ...
        <div class="card-header">
            ...
            <div class="card-meta">
                <span class="meta-badge">
                    ...
                    {{ $ekstrakulikuler->created_at->format('d M Y') }}
                </span>
                <span class="meta-badge">
                    <i class="fas fa-images"></i>
                    {{ count(json_decode($ekstrakulikuler->gambar, true) ?? []) }} Foto
                </span>
            </div>
        </div>
            ...
            <div class="info-section">
                <div class="info-row">
                    ...
                    <div class="info-value">
                        {{ $ekstrakulikuler->namaekstrakulikuler }}
                    </div>
                </div>
                ...
                <div class="photo-gallery">
                            ...
                            <div class="photo-item">
                                <div class="photo-wrapper">
                                    <img src="{{ Storage::url($image) }}"
                                         alt="Foto {{ $ekstrakulikuler->namaekstrakulikuler }} - {{ $index + 1 }}"
                                         class="photo-image">
                    ...
                    @else
                        <div class="no-photos">
                            ...
                            <p>Ekstrakurikuler ini belum memiliki dokumentasi gambar</p>
                        </div>
                    @endif
                </div>
            </div>
...
@section('scripts')
    <script>
        ...
        const images = @json(json_decode($ekstrakulikuler->gambar, true) ?? []);
