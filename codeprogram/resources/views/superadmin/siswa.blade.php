                ...
                <div class="acara-grid">
                    @foreach($siswa as $item)
                        <div class="acara-card">
                            ...
                            <!-- Tombol Aksi -->
                            <div class="acara-header" style="justify-content: flex-end;">
                                <div class="acara-actions">
                                    <a href="{{ route('superadmin.siswa.edit', $item->siswa_id) }}" 
                                       class="action-btn edit-btn" 
                                       title="Edit">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="{{ route('superadmin.siswa.destroy', $item->siswa_id) }}" 
                                          method="POST" 
            ...
            @else
                <!-- <div class="empty-state">
                    <div class="empty-content">
                        ...
                        <p class="empty-subtitle">Mulai dengan menambahkan data kelas pertama Anda</p>
                        <a href="{{ route('superadmin.siswa.create') }}" class="btn btn-primary">
                            <i class="fas fa-plus"></i> Tambah Data
                        </a>
                    </div>
