...
<div class="container mt-5">
    ...
    <form action="{{ route('superadmin.pegawai.update', $guru->guru_id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <a href="{{ route('superadmin.pegawai.index') }}" class="btn btn-secondary">Kembali</a>
    </form>
</div>
